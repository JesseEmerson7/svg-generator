...
describe("SVG", () => {
  test("should return rendered circle SVG", () => {
    const testSvg = new SVG("svg","black",`<circle cx="150" cy="100" r="80" fill="blue" />`,125);
  ...
  test("should return rendered Square SVG", () => {
    const testSvg = new SVG("svg","black",`<rect x="90" y="40" width="120" height="120" fill="blue" />`,125);
    const expectedString=`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
  ...
  test("should return rendered Triangle SVG", () => {
    const testSvg = new SVG("svg","black",`<polygon points="150, 18 244, 182 56, 182" fill="blue" />`,150);
    const expectedString=`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
