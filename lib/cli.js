  ...
  run() {
    return inquirer
      ...
      .then((answers) => {
        ...
        //svg class is created using the values entered plus the shape render method and yAxis value
        //using the SVG render method the svg code is returned.
        const newSvg = new SVG(textAndColor[0],textAndColor[1],shapeElement,selectedShape.yAxis)
